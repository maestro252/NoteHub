...
//  NoteHub
//
//  Created by Jonathan Eidelman on 15/09/14.
...
{
    return (section == 0) ? [colours count] : 2;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        cell.textLabel.text = [[colours allKeys] objectAtIndex:indexPath.row];
    }
